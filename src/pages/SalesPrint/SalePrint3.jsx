...
const SalePrint3 = ({ token, invoiceNo, printName, urls, evn, ApiVer, }) => {
  ...
  const [metalFineWtFlag, setMetalFineWtFlag] = useState(false);
  const [metalFineWtFlagColWise, setMetalFineWtFlagColWise] = useState(false);
  const [tunchFlag, setTunchFlag] = useState(true);
  const [tunchFlagColWise, setTunchFlagColWise] = useState(true);
  const [diaClrGroupEffectFlag, setDiaClrGroupEffectFlag] = useState(true);
  const [otherChargesBrf, setOtherChargesBrf] = useState(false);
  ...
  useEffect(() => {
    ...
    if(print_name === 'detail print1 group(l)' || print_name === 'detail print1 group(p)'){
      setMetalFineWtFlag(false);
      setMetalFineWtFlagColWise(false);
      setTunchFlag(true);
      setTunchFlagColWise(false);
      setDiaClrGroupEffectFlag(true);
      setOtherChargesBrf(false);
    }
    if(print_name === 'detail print k'){
      setMetalFineWtFlag(false);
      setMetalFineWtFlagColWise(false);
      setTunchFlag(false);
      setTunchFlagColWise(false);
      setDiaClrGroupEffectFlag(false);
      setOtherChargesBrf(false);
    }
    if(print_name === 'detail print r'){
      setMetalFineWtFlag(false);
      setMetalFineWtFlagColWise(false);
      setTunchFlag(true);
      setTunchFlagColWise(false);
    ...
    if(print_name === 'detail print c'){
      setMetalFineWtFlag(true);
      setMetalFineWtFlagColWise(true);
      setTunchFlag(true);
      setTunchFlagColWise(true);
      setDiaClrGroupEffectFlag(false);
      setOtherChargesBrf(true);
    }
    if(print_name === 'detail print1 (p)' || print_name === 'detail print1 (l)'){
      setMetalFineWtFlag(false);
      setMetalFineWtFlagColWise(false);
      setTunchFlag(true);
      setTunchFlagColWise(false);
                ...
                <div className="d-grid h-100">
                  ...
                  <div className="d-flex border-bottom ">
                    ...
                    <p className="fw-bold col-2 border-end  d-flex align-items-center justify-content-center">
                      { tunchFlagColWise ? 'Tunch' : '*Wt'}
                    </p>
                    <p className="fw-bold col-2 border-end  d-flex align-items-center justify-content-center">
                      { metalFineWtFlagColWise ? 'FineWt' : 'N+L'}
                    </p>
                    <p className="fw-bold col-2 border-end  d-flex align-items-center justify-content-center">
                      Rate
                    </p>
                  ...
                  <div className="d-flex w-100">
                    ...
                    <div className="designDetalPrint1 border-end  p-1 border-bottom paddingLeftDetailPrint1 paddingRightDetailPrint1">
                      ...
                      <div className={`${!image && "pt-2 "}`}>
                        ...
                        {tunchFlagColWise ? '' : (
                          <>
                          { tunchFlag && <p className="text-center">
                            Tunch :{" "}
                        ...
                        {metalFineWtFlagColWise ? '' : (
                          <>
                          { metalFineWtFlag && <p className="text-center">
                            FineWt :{" "}
                            <span className="fw-bold">
                            ...
                            return (
                              <div className={`d-flex justify-content-between `} key={ind} >
                                ...
                                <p className="col-2 paddingRightDetailPrint1">
                                  { diaClrGroupEffectFlag ?  ele?.GroupName :  <>
                                    {ele?.GroupName === ""
                                    ? ele?.SizeName
                                    : ele?.GroupName}
                                  </>}
                                ...
                                <>
                                  {e?.OtherCharges + e?.MiscAmount+e?.TotalDiamondHandling !== 0 && (
                                    <>
                                      ...
                                      </> : <div className="d-flex justify-content-between" style={{ fontSize: "10.5px" }} >
                                        <p className="paddingRightDetailPrint1"></p>
                                        <p className="">
