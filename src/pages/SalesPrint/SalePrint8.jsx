// invoice print 5, 7, 12, tax invoice print 4
...
import "../../assets/css/salesprint/saleprint8.css";
// import "../../assets/css/prints/invoiceprint5.css";

const SalePrint8 = ({ token, invoiceNo, printName, urls, evn, ApiVer }) => {
