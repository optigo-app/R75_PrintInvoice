...
import { Box, Button, Grid, useMediaQuery, useTheme, Select, MenuItem, Typography, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, Card   } from '@mui/material';
    ...
    <Grid container spacing={1} sx={{marginBottom:'3rem', padding: isSmallScreen ? '1rem' : '1rem', width:'95%', margin:'2% auto', marginTop:"0px" }}>
      ...
      >
        ...
        <Grid item xs={12} sm={2} md={2} >
            <Card style={{minHeight:'238px', boxShadow:'0px 4px 18px 0px rgba(47, 43, 61, 0.1)',}} className='fs_analytics_l '>Hello</Card>
          {/* <AccountHr tkn={tkn} InventoryRatio={InventoryRatio} saleMTs={saleMTs} PrdDev={PrdDev} avgCollRatio={avgCollRatio} apiData1={apiData1} bgColor={theme?.palette?.customColors?.purple} acrLoader={acrLoader} irLoader={irLoader} PDLoader={PDLoader} /> */}
        </Grid>
        ...
        { !isMaxWidth1700px && <>
        <Grid item xs={12} md={12} lg={12}><HeaderOfCard headerName="SALES & MARKETING" bgColor={'#7d5ae773'} /></Grid>
        <Grid item xs={12} md={6} lg={7}>
