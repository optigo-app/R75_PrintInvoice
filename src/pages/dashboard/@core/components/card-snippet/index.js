...
const CardSnippet = props => {
  ...
  return (
    <Card
      className={`${className} fs_analytics_l`}
      style={{ boxShadow: '0px 4px 18px 0px rgba(47, 43, 61, 0.1)' }}
    ...
    >
      ...
      /> */}
      <CardContent className='fs_analytics_l' >{children}</CardContent>
      {hidden ? null : (
        <Collapse in={showCode}>
          <Divider sx={{ my: '0 !important' }} />

          <CardContent sx={{ position: 'relative', '& pre': { m: '0 !important', maxHeight: 500 } }} className='fs_analytics_l' >
