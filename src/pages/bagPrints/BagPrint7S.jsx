                          ...
                          return (
                            <React.Fragment key={ind}>
                              <div className="container7A">
                                <div className="head7A" style={{ height: "163px" }}>
                                ...
                                <div className="main7A">
                                  <div className="main7AEntry" style={{ width: "186px" }}>
                                    ...
                                    <div className="d-flex">
                                      <div>
                                        <div className="tableHead7B" style={{ width: "186px" }}>
                                          <div
                                          ...
                                          <div className="dept7A fw-bold" style={{ borderRight: "none" }}>
                                            WrKr
                                          </div>
                                        </div>
                                        ...
                                        >
                                          ...
                                          <div
                                            className="dept7A fs7A"
                                            style={{ width: "63px", lineHeight: "8px" }}
                                          >
                                            Extra <br /> Metal
                                          </div>
                                  ...
                                  <div className="main7AEntry2" style={{ width: "162px", borderLeft: "none" }}>
                                    <div className="w-100 d-flex justify-content-between align-items-center sizehead7A fw-bold" style={{ borderTop: "1px solid #989898" }}>
                                      <div
                          ...
                          <div className="main7A">
                            <div className="main7AEntry" style={{ width: "186px" }}>
                              ...
                              <div className="tableHead7B" style={{ width: "186px" }}>
                                ...
                                <div className="dept7A fw-bold" style={{ borderRight: "none" }}>WrKr</div>
                              ...
                              <div
                                className="tableHead7B"
                                style={{ fontWeight: "bold", height: "16px", width: "186px", borderRight: "none" }}
                              >
                                <div
                                  className="dept7A"
                                  style={{ width: "36%" }}
