...
const TaxInvoice5S = ({ token, invoiceNo, printName, urls, evn, ApiVer }) => {
  ...
  const [GrossWtFlag, setGrossWtFlag] = useState(false);
          ...
          <tr>
            <td>
              <div className="invoice-content-body">
                ...
                >
                  <div className="form-check ps-3 mt-2 flex items-center justify-end ">
                    ...
                    <div className="w-full flex items-center justify-end spfnthead head_Chkbx">
                      <input
                        ...
                        className="mx-1"
                        checked={GrossWtFlag}
                        onChange={() => setGrossWtFlag(!GrossWtFlag)}
                      />
                      <label htmlFor="grosswtDec" className="me-3 user-select-none">Gr.wt. 2 decimal</label>
                    </div>
                    <input
                      type="button"
                ...
                <div className={`${style2.companyDetails} ${style?.lhheaderti5}`}>
                  <div className={`${style2.companyhead} ${style?.lhheaderti5} p-2 `}>
                    ...
                    <div className={`px-1  ${style?.lhheaderti5}`}> {headerData?.CINNO ? "CIN-" : ""}{headerData?.CINNO}</div>
                  </div>

                  <img src={headerData?.PrintLogo} height="80" width="110" alt="" className="headImg_Pcl7" />
                </div>
                {/* sub header */}
                  ...
                  return (
                    <div className="d-flex border-start border-end border-bottom no_break" key={i}>
                      ...
                      <div className={`${style?.Gross} border-end`}>
                        <p className="text-end p-1">{NumberWithCommas(e?.grosswt, GrossWtFlag ? 2 : 3)}</p>
                      </div>
                ...
                <div className="d-flex border-start border-end border-bottom no_break">
                  ...
                  <div className={`${style?.Gross} border-end`}>
                    <p className="text-end p-1 fw-bold">
                      {NumberWithCommas(data?.mainTotal?.grosswt, GrossWtFlag ? 2 : 3)}
                    </p>
                  </div>
                  <div className={`${style?.Net} border-end`}>
                    <p className="text-end p-1 fw-bold">
                ...
                <div style={{ width: "100%", margin: "auto", textAlign: "center" }}>
                  ...
                  {(headerData?.CompanyTellNo ||
                    ...
                    headerData?.CompanyWebsite) && (
                      <p style={{ margin: 0 }} className="foot-font">
                        {headerData?.CompanyTellNo && `• Tel : +${headerData.CompanyTellNo} `}
                        {headerData?.CompanyEmail && `• ${headerData.CompanyEmail} `}
                        {headerData?.CompanyWebsite && `• ${headerData.CompanyWebsite} `}
                      </p>
                    )}
