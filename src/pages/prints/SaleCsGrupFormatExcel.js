// http://localhost:3000/?tkn=OTA2NTQ3MTcwMDUzNTY1MQ==&invn=U0syMTI2MjAyNA==&evn=c2FsZQ==&pnm=c2FsZSBjcyBncnVwIGZvcm1hdA==&up=aHR0cDovL3plbi9qby9hcGktbGliL0FwcC9TYWxlQmlsbF9Kc29u&ctv=NzE=&ifid=PackingList3&pid=undefined&etp=ZXhjZWw=
...
const SaleCsGrupFormatExcel = ({
  ...
  const handleDownloadExcel = () => {
    ...
    const totalRow = {
      ...
      FindingMacAMT1: excelData.reduce((sum, row) => sum + row.FindingMacAMT1, 0),
      FindingWT2: excelData.reduce((sum, row) => sum + row.FindingWT2, 0),
      FindingMacRATE2: "", // Rates are not summed.
      FindingMacAMT2: excelData.reduce((sum, row) => sum + row.FindingMacAMT2, 0),
    };
...
export default SaleCsGrupFormatExcel;
