...
const SaleFormateExcel = ({
  ...
  const handleDownloadExcel = () => {
    const excelData = result?.resultArray.flatMap((item) => 
      item.all_m_d_c_m?.map((subData) => ({
        invoiceno: item.StockDocumentNo || "",
        FG_Date: item?.PromiseDate,
        Sale_Date: item?.PromiseDate, 
        Reference: item?.E_Reference_No,
        CustomerCode: result?.header?.CustName,
        Jobno: item.SrJobno || "",
        DesignNo: item.designno || "",
        Brand: item.BrandName || "",
        Collection: item.Collectionname || "",
        Category: item.Categoryname || "",
        CategoryPrefix: item.designno || "",
        ...
        Quality: subData.QualityName || "",
        Color: subData.Colorname || "",
        Size: subData.SizeName || "",
    ...
    //   const mdc = item.all_m_d_c_m?.[0] || {}; // Get first element of `all_m_d_c_m`
    //   return {
    //     invoiceno: mdc.StockDocumentNo || "",
    //     FG_Date: item?.PromiseDate, // Static or dynamic
    //     Sale_Date: item?.PromiseDate, // Static or dynamic
    //     Reference: item?.E_Reference_No,
    //     CustomerCode: result?.header?.CustName,
    //     Jobno: item.SrJobno || "",
    //     DesignNo: item.designno || "",
    ...
    //     ProductType: item?.Product_Type,
    //     Component: "",
    //     Material: mdc.MasterManagement_DiamondStoneTypeName || "",
    //     Type: "",
    //     Shape: item.MetalType || "",
    //     Quality: item.MetalPurity || "",
    //     Color: item.MetalColor || "",
    //     Size: mdc.Size || "",
    //     Setting: mdc.Setting || "",
    //     Pcs: item.Pcs || "",
    //     Weight: item.MetalWeight || 0,
    //     PriceRatio: item.MetalPriceRatio || "",
    //     Supplier: mdc.Supplier || "",
    //     AddInGrossWt: mdc.AddInGrossWt || "",
    //     RateOnPcs: mdc.RateOnPcs || "",
    //     SaleMarkup: mdc.SaleMarkup || "",
    //     SalesMarkupIn: mdc.SalesMarkupIn || "",
    //     IsOnPcs: mdc.IsOnPcs || "",
    //     IsSampleLineJob: mdc.IsSampleLineJob || 0,
    //     PurchaseWastage: mdc.PurchaseWastage || 0,
    //     SaleWastage: mdc.SaleWastage || 0,
    //     Location: mdc.Location || "",
    //     GroupJob: mdc.GroupJob || "",
    //     SalesLabour: mdc.SalesLabour || 0,
    //     SalesLabourOn: mdc.SalesLabourOn || "",
    //     SaleRate: mdc.Rate || "",
    //     SaleAmount: item.MetalAmount || "",
    //     OldTag: mdc.OldTag || "",
    //     PurchaseMRP: mdc.PurchaseMRP || 0,
    //     SaleMRP: mdc.SaleMRP || 0,
    //   };
    // });
    ...
    XLSX.writeFile(workbook, "Jewellery_Data.xlsx");
  };
            ...
            <>
              <div style={{ paddingBottom: "5rem" }}>
                ...
                <table id="table-to-xls">
                  <button onClick={handleDownloadExcel}>Click print</button>
                </table>
              </div>
            </>
          ) : (
...
export default SaleFormateExcel;
