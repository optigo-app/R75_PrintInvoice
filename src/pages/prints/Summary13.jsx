...
const Summary13 = ({ urls, token, invoiceNo, printName, evn, ApiVer }) => {
    ...
    const countTotal = (arr, taxJson) => {
        ...
        arr.forEach((e, i) => {
            ...
            resultObj.lossWt += e?.LossWt;
            resultObj.MakingAmount += e?.MakingAmount;
        })
                        ...
                        <div>
                            ...
                            <div className="sum4_table">
                                <div className='d-flex border-bottom no_break'>
                                    ...
                                    <div className='p-1 fw-bold border-end align-middle text-center nwt_sum4'><p>Wastage</p></div>
                                    ...
                                    <div className='p-1 fw-bold border-end align-middle text-center gold_fine_sum4'><p>Making</p></div>
                                ...
                                {BillPrintJson1.length > 0 && BillPrintJson1.map((e, i) => {
                                    ...
                                    return <div className="d-flex border-bottom no_break" key={i}>
                                        ...
                                        <div className="p-1 remark_sum4 border-end text-end remark_sum4"> <p> {e?.CertificateNo} </p> </div>
                                        ...
                                        <div className="p-1 nwt_sum4 border-end text-end "> <p> {fixedValues((e?.LossWt), 3)} </p> </div>
                                        ...
                                        <div className="p-1 gold_fine_sum4 border-end text-end "> <p> {NumberWithCommas(e?.MakingAmount, 2)} </p> </div>
                                ...
                                <div className="total_sec_sum4 d-flex border-bottom mb-1 no_break">
                                    ...
                                    <div className="p-1 nwt_sum4 border-end text-end bg_total_sum4 fw-bold "> <p> {fixedValues(total.lossWt, 3)} </p> </div>
                                    ...
                                    <div className="p-1 gold_fine_sum4 border-end text-end  bg_total_sum4 fw-bold"> <p> {NumberWithCommas(total.MakingAmount, 2)} </p> </div>
