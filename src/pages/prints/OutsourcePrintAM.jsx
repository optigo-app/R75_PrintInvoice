...
const OutsourcePrintAM = ({ urls, token, invoiceNo, printName, evn, ApiVer }) => {
        ...
        <div className="container containerEstimate pad_60_allPrint">
          ...
          <div className="sphed">
            <div className="justify-content-start spbrWord">
              ...
              <div>
                {json1Data?.CompanyCity}-
                {json1Data?.CompanyPinCode},
                {json1Data?.CompanyState}(
                {json1Data?.CompanyCountry})
              </div>
              <div>T {json1Data?.CompanyTellNo}</div>
              <div>
                {json1Data?.CompanyEmail} | +
                {json1Data?.CompanyWebsite}
              </div>
              <div>
                {json1Data?.Company_VAT_GST_No} |{" "}
                {json1Data?.Company_CST_STATE} -{" "}
                {json1Data?.Company_CST_STATE_No} | PAN -{" "}
                {json1Data?.Com_pannumber}
              </div>
            </div>
            {logoMap[checkBoxNew] && (
              <div className="justify-content-end">
                <img
                  ...
                  style={{ width: "190px", paddingTop: "18px" }}
                />
              </div>
            )}
          </div>
          ...
          <div className="w-100">
            ...
            {/** data */}
            <div style={{ paddingBottom: "5px", borderRight: "1px solid black", borderLeft: "1px solid black" }}>
              {json2Data.length > 0 &&
                json2Data.map((e, i) => {
                  return (
                    <div
                      className={`d-flex border-bottom recordEstimatePrint overflow-hidden word_break_estimatePrint 
                        ${i === 6 && json2Data.length > 6 ? 'print-top-border' : ''}
                        ${i === 4 && json2Data.length > 4 ? 'print_top_border_land' : ''}
                        `}
                      key={i}>
                      ...
                      <div className="designEstimatePrint border-end  border_color_estimates d-flex justify-content-between flex-column">
                        <div className="d-flex justify-content-between p_1Estimate">
                          ...
                          {e?.Quantity !== null && <div className="spbrWord">QTY:{e?.Quantity}</div>}
                                ...
                                <div className="width_40_estimatePrint p_1Estimate">
                                  {(() => {
                                          ...
                                          if (matchedItems && matchedItems.length > 0) {
                                            ...
                                            return <p className="text-end">{fixedValues(el?.Wt,2)}</p>;
                                          }
                                    })()}
                                </div>
                              <div className="width_40_estimatePrint p_1Estimate">
                                  <p className="text-end ">{fixedValues(el?.Wt,2)}</p>
                                </div>
                              </div>
                            ))}
                          {e?.finding?.map((el, ol) => {
                            return (
                              <div className="d-flex" key={ol}>
                                  <div className="Suwidth_40_estimatePrint p_1Estimate">
                                    <p className="spspcLft spbrWord">
                                      {el?.FindingTypename} {el?.FindingAccessories}
                                    </p>
                                  </div>
                                  <div className="width_40_estimatePrint p_1Estimate">
                                    <p className="text-end">
                                    {
                                        (() => {
                                          const matchedItems = mergeMetalDiamondwt?.findingWeights
                                            ?.flat()
                                            .filter(
                                              (ele) =>
                                                e?.J_JobNo === ele?.J_JobNo &&
                                ...
                                <div className="d-flex" key={ol}>
                                  ...
                                  <div className="width_40_estimatePrint p_1Estimate">
                                    <p className="text-end">
                                      {
                                        (() => {
                                          const matchedItems = mergeMetalDiamondwt?.anotherFindingWeights
                                            ?.flat()
                                            .filter(
                                              (ele) =>
                                                e?.J_JobNo === ele?.J_JobNo &&
            ...
            <div className="d-flex recordEstimatePrint justify-content-between overflow-hidden border-start border-end border_color_estimates top-border">
              {/* summary */}
...
export default OutsourcePrintAM;