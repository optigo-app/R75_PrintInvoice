            ...
            <div>
                ...
                <div className='border-2 border-black mt-1'>
                    <div className='d-flex fw-bold  border-2 border-top-0 border-start-0 border-end-0 border-black'>
                        <div style={{width:'10%'}} className='p-1 border-2 border-black border-top-0 border-start-0 border-bottom-0'>Description</div>
                        <div style={{width:'90%'}} className='d-flex align-items-center'>
                            <div className='col1_invp1_ms ps_g'>Description</div>
                    ...
                    <div>
                        {
                            data?.map((e, i) => {
                                return <div key={i} className='d-flex'>
                                    <div style={{width:'10%'}} className='p-1 border-2 border-black border-top-0 border-start-0 border-bottom-0'>{e}&nbsp;</div>
                                    <div style={{width:'90%'}} className='d-flex align-items-center'>
                                        <div className='col1_invp1_ms ps_g'>Description</div>
                                        <div className='col2_invp1_ms'>Weight</div>
                                        <div className='col3_invp1_ms'>Rate</div>
                    ...
                    <div className='d-flex fw-bold'>
                        <div style={{width:'10%'}} className='border-2 border-black border-top-0 border-start-0 border-bottom-0'>&nbsp;</div>
                        <div style={{width:'90%'}} className='d-flex align-items-center'>
                            <div className='col1_invp1_ms ps_g'>Total</div>
                ...
                <div className='p-1 mt-1 border-2 border-black'>
                    ...
                    <div>Kindly make your payment by the name of <span className='fw-bold'>"Orail services"</span></div>
                    <div>Payable at Surat (GJ) by cheque or DD</div>
                    <div>Bank Detail : Bank Account No <span className='fw-bold'>147275899632</span></div>
