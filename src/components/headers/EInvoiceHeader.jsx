...
import style from "../../assets/css/headers/einvoiceheader.module.css";
import { handleGlobalImgError } from '../../GlobalFunctions';

const EInvoiceHeader = ({ data }) => {
  return (
    <div className={style.header3}>
      ...
      <div className={`${style.companyDetails} d-flex justify-content-between align-items-start w-100 `} >
        ...
        <div className="" style={{width:"40%"}}>
          <div className={style.qrcodeupperdivh3} style={{maxHeight:'250px'}}>
            ...
            <img src={data?.E_Qr} alt="" style={{objectFit:'contain'}} onError={handleGlobalImgError} />
          </div>
